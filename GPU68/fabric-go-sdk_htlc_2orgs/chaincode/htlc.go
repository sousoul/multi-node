...
//func Lock(stub shim.ChaincodeStubInterface, hashValue string, timeLockStr string) (string, error) {
//	// 1. 哈希值、时间值上链
//	timeLock, _ := strconv.ParseInt(timeLockStr, 10, 64)
//	//if err != nil {
//	//	return "failed", shim.Error(err.Error())
//	//}
//
//	htlc := HTLC{
//		HashValue:   hashValue,
...
//func withdraw_1(preimage string)  {
//	// 1. 读取哈希值、时间值
//	// 2. 判断是否相等
//	// 3. 判断超时
//}
...
//	preimage = "rootroot"
//	Hash_value = "0242c0436daa4c241ca8a793764b7dfb50c223121bb844cf49be670a3af4dd18"
//
